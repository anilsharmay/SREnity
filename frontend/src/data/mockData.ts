...
export const mockAlerts: Alert[] = [
  {
    ...
    severity: 'P1',
    title: 'Multiple Services Experiencing Errors',
    started: 'Nov 12, 02:47 AM',
    affects: 'Multiple production services',
    description: 'Increased error rates, connection timeouts, and slow operations affecting multiple services. Users experiencing degraded performance.',
